...
def solve_data(msg: str, pos: bool):
    if pos:
        addresses = get_address('get sub', RECV_PORT, DATA_PORT)
        for address in addresses:
            send_data(msg, address[0])
    else:
        address = get_address('get pub', RECV_PORT, DATA_PORT)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        solve_data(json.dumps(send_res), positive)
